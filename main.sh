#!/bin/bash
#FN indossh indo-ssh.com
#RERECHAN02
#link izin ip vps
url_izin='https://raw.githubusercontent.com/Rerechan02/ip/main/master/izin1.rere'
...
KEY="6187251915:AAH_6YqHWpElw-S7_n5208ibAEvHWshk6jg"
URL="https://api.telegram.org/bot$KEY/sendMessage"
REPO="https://raw.githubusercontent.com/Rerechan02/vip/main/"
CHATID="-1001826721069"
...
function base_package() {
    print_install "Menginstall tools"
    ...
    apt-get clean all
    print_ok "Berhasil menginstall tools yang dibutuhkan"
}
clear
...
function install_xray(){
    print_install "Memasang Xray Core Official"
...
### Tambahan
function tambahan(){
    print_install "Memasang menu tambahan"
